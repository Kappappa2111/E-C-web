                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="banner banner-overlay">
                                    <a href="{{ URL::to('/product_all') }}">
                                        <img src="{{ asset('UserLTE/assets/images/demos/demo-6/banners/banner-2.jpg') }}"
                                            alt="Banner">
                                    </a>
                                    ...
                                    <div class="banner-content banner-content-center">
                                        <h4 class="banner-subtitle text-white"><a href="{{ URL::to('/product_all') }}">Quần áo</a></h4>
                                        <!-- End .banner-subtitle -->
                                        <h3 class="banner-title text-white"><a href="{{ URL::to('/product_all') }}"><strong>Nam</strong></a></h3>
                                        <!-- End .banner-title -->
                                        <a href="{{ URL::to('/product_all') }}" class="btn btn-outline-white banner-link underline">Shop Now</a>
                                    </div><!-- End .banner-content -->
                                </div><!-- End .banner -->
